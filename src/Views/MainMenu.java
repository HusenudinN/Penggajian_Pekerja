/*
 * Program ini dibuat oleh Husenudin Nurdiansyah dan Aishi Putiara
 * Untuk Tugas Praktikum Rekayasa Perangkat Lunak Lanjut
 */
...
// <editor-fold defaultstate="collapsed" desc="initComponents() Method">
    private void initComponents() {
        ...
        this.setTitle("Aplikasi Penggajian Pegawai");
        ...
        getTentangBtn().setBorder(null);
        getTentangBtn().setBounds(0, 255, 193, 60);
...
//<editor-fold defaultstate="collapsed" desc="userInitComponents() Method">
    ...
    private void userInitComponents(String judul){
        ...
        getTentangBtn().setOpaque(true);
        getTentangBtn().setBorder(null);
        getTentangBtn().setBounds(0, 195, 193, 60);
        getLeftPanel().add(getTentangBtn());
        //kelompok tombol isi menu
        //tombol hitung gaji
        getHitungGajiBtn().setOpaque(true);
